<?php $__env->startSection('title', 'Monitoring Dokumen - SiDoRa'); ?>
    ...
    <div class="w-full mb-6">
        <div class="bg-white shadow-md rounded-2xl p-2 flex flex-col sm:flex-row gap-2 overflow-x-auto">
            <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('tu.monitoring', ['tab' => $key])); ?>"
            ...
            <div class="max-h-[400px] overflow-y-auto" style="scrollbar-width: thin; scrollbar-color: #050C9C #f1f5f9;">
                <table class="w-full text-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        <?php $__empty_1 = true; $__currentLoopData = $dokumens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-blue-50/30 transition-all duration-200 group">
                            <td class="py-3 px-4 text-xs font-medium text-gray-500">
                                <?php echo e($dokumens->firstItem() + $index); ?>
                            ...
                            <td class="py-3 px-4">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[10px] text-gray-500"><?php echo e($d->nomor_dokumen ?? 'No. Dokumen'); ?></p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="py-3 px-4">
                                ...
                                ?>
                                <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-semibold <?php echo e($badgeClass); ?>">
                            ...
                            <td class="py-3 px-4 text-xs text-gray-600">
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <?php echo e(\Carbon\Carbon::parse($d->tanggal_terbit)->translatedFormat('d M Y')); ?>
                            ...
                            <td class="py-3 px-4">
                                <div class="flex items-center gap-2">
                                    <a href="<?php echo e(route('tu.edit-hak-akses', $d->dokumen_id)); ?>" 
                                    ...
                                    <a href="<?php echo e(route('tu.detail-dokumen', $d->dokumen_id)); ?>"
        ...
        <div class="bg-gray-50 px-4 sm:px-6 py-3 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row justify-between items-center gap-3">
                <div class="flex items-center gap-2 text-xs text-gray-600">
                    ...
                    <span class="font-bold text-[#050C9C]"><?php echo e($total); ?></span>
                </div>
                
                <div class="flex flex-col sm:flex-row items-center gap-3">
                    <span class="text-xs text-gray-600 font-medium">
                        Halaman <?php echo e($dokumens->currentPage()); ?> dari <?php echo e($dokumens->lastPage()); ?>

                    </span>
                    
                    <div class="flex items-center gap-1.5">
                        <?php if($dokumens->onFirstPage()): ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($dokumens->previousPageUrl()); ?>" 
                        ...
                        <div class="hidden sm:flex items-center gap-1.5">
                            <?php $__currentLoopData = $dokumens->getUrlRange(1, $dokumens->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($page == $dokumens->currentPage()): ?>
                        ...
                        <?php if($dokumens->hasMorePages()): ?>
                            <a href="<?php echo e($dokumens->nextPageUrl()); ?>" 
                               class="px-2.5 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-[#050C9C] hover:text-white hover:border-[#050C9C] transition-all duration-200 shadow-sm">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<link rel="stylesheet" href="<?php echo e(asset('css/tu/monitoring.css')); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
<script src="<?php echo e(asset('js/tu/monitoring.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMESTER 3 TEKNIK INFORMATIKA\PROYEK-3-PBO\APK-MANAJEMEN-DOSEN\devOps\devOps\resources\views/tu/monitoring.blade.php ENDPATH**/ ?>