<?php $__env->startSection('title', 'Edit Hak Akses - SiDoRa'); ?>
        ...
        <div class="overflow-y-auto max-h-[calc(90vh-180px)] px-6 py-6 space-y-6">
            ...
            <div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-gray-800"><?php echo e($dokumen->judul ?? 'Riwayat Pengajaran'); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($dokumen->nomor_dokumen ?? 'RP-2025-001'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="p-3">
                                    ...
                                    <div id="userListContainer">
                                        <?php $__currentLoopData = $users ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="user-checkbox-item flex items-center px-3 py-2.5 hover:bg-gray-50 rounded-lg cursor-pointer transition group" data-search="<?php echo e(strtolower($user->nama_lengkap . ' ' . $user->email)); ?>">
                                                <input type="checkbox" name="user_ids[]" value="<?php echo e($user->id_user); ?>" class="hak-akses-checkbox w-4 h-4 text-[#050C9C] border-gray-300 rounded focus:ring-[#050C9C] focus:ring-2">
                                                <div class="ml-3 flex-1">
                                                    <div class="text-sm font-medium text-gray-900 group-hover:text-[#050C9C] transition-colors"><?php echo e($user->nama_lengkap ?? 'User'); ?></div>
                                                    <div class="text-xs text-gray-500"><?php echo e($user->email); ?> (<?php echo e(ucfirst($user->role)); ?>)</div>
                                                </div>
                                            </label>
            ...
            <div>
                ...
                <div id="accessList" class="space-y-2 max-h-64 overflow-y-auto pr-2">
                    <?php $__empty_1 = true; $__currentLoopData = $dokumen->accessControls ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $access): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 transition-all duration-200 group" data-user-id="<?php echo e($access->granteeUser->id_user ?? 0); ?>">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm shadow-md">
                                <?php echo e(strtoupper(substr($access->granteeUser->email ?? 'U', 0, 2))); ?>

                            </div>
                            <div>
                                <p class="font-semibold text-sm text-gray-800"><?php echo e($access->granteeUser->email ?? 'User'); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e(ucfirst($access->granteeUser->role ?? 'User')); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            ?>
                            <span class="px-3 py-1 <?php echo e($permClass); ?> text-xs font-semibold rounded-full border">
                                <?php echo e($access->perm); ?>

                            </span>
                            <button type="button" onclick="removeAccess(<?php echo e($access->granteeUser->id_user ?? 0); ?>, '<?php echo e($access->granteeUser->email ?? ''); ?>')" 
...
<script>
    window.dokumenId = <?php echo e($dokumen->dokumen_id ?? 0); ?>;
    window.csrfToken = '<?php echo e(csrf_token()); ?>';
    window.monitoringRoute = '<?php echo e(route("tu.monitoring")); ?>';
    window.removeAccessRoute = '<?php echo e(route("tu.hak-akses.remove", ["id" => $dokumen->dokumen_id])); ?>';
    window.updateAccessRoute = '/tu/dokumen/<?php echo e($dokumen->dokumen_id); ?>/hak-akses';
</script>

<?php $__env->stopSection(); ?>

<?php $__env->startPush('styles'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/tu/edit-hak-akses.css')); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
<script src="<?php echo e(asset('js/tu/edit-hak-akses.js')); ?>"></script>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMESTER 3 TEKNIK INFORMATIKA\PROYEK-3-PBO\APK-MANAJEMEN-DOSEN\devOps\devOps\resources\views/tu/edit-hak-akses.blade.php ENDPATH**/ ?>