...
<aside id="sidebar"
    ...
    <nav class="w-full mt-2 md:mt-4 space-y-2">
        ...
        <?php elseif($role === 'tu'): ?>
            ...
            <a href="<?php echo e(url('/tu/monitoring')); ?>"
                class="flex items-center gap-3 px-6 py-3 rounded-full mx-2 font-semibold  transition
                <?php echo e(request()->is('tu/monitoring') ? 'bg-[#050C9C] text-white' : 'text-black hover:text-[#050C9C]'); ?>">
...
<?php /**PATH D:\SEMESTER 3 TEKNIK INFORMATIKA\PROYEK-3-PBO\APK-MANAJEMEN-DOSEN\devOps\devOps\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>