<?php $__env->startSection('title', 'Dashboard Dosen - SiDoRa'); ?>
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <p class="text-gray-500">
                Selamat datang kembali, <?php echo e(Auth::user()->nama_lengkap ?? 'Dosen'); ?> 👋
            </p>
        </div>
            ...
            <div class="bg-white/40 backdrop-blur-lg p-6 rounded-2xl shadow border border-white/30">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-4xl font-extrabold text-[#050C9C] mt-2"><?php echo e($totalRPS); ?></p>
                    </div>
            ...
            <div class="bg-white/40 backdrop-blur-lg p-6 rounded-2xl shadow border border-white/30">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-4xl font-extrabold text-[#050C9C] mt-2"><?php echo e($totalSKP); ?></p>
                    </div>
                    <div class="bg-blue-100 text-[#050C9C] p-3 rounded-xl shadow-inner">
            ...
            <div class="bg-white/40 backdrop-blur-lg p-6 rounded-2xl shadow border border-white/30">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-4xl font-extrabold text-[#050C9C] mt-2"><?php echo e($totalBKD); ?></p>
                    </div>
                    <div class="bg-blue-100 text-[#050C9C] p-3 rounded-xl shadow-inner">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white/40 backdrop-blur-lg p-6 rounded-2xl shadow border border-white/30 col-span-2">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('dosen.riwayat-upload') ?? '#'); ?>"
                ...
                <canvas id="uploadChart" height="120"
                    data-tanggal='<?php echo json_encode($tanggal, 15, 512) ?>'
            ...
            <div class="bg-gradient-to-br from-[#050C9C] to-blue-500 text-white p-6 rounded-2xl shadow flex flex-col justify-between">
                ...
                <a href="<?php echo e(route('dosen.upload') ?? '#'); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMESTER 3 TEKNIK INFORMATIKA\PROYEK-3-PBO\APK-MANAJEMEN-DOSEN\devOps\devOps\resources\views/dosen/dashboard.blade.php ENDPATH**/ ?>