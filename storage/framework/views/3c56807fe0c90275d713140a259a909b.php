...
<?php $__env->startSection('content'); ?>
    <div class="p-6 max-w-6xl mx-auto">
        ...
        <div class="form-card bg-white rounded-2xl shadow-xl p-8">
            ...
            <form id="uploadForm" method="POST" action="<?php echo e(route('tu.upload.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="judul" value="<?php echo e(old('judul')); ?>" class="input-field w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#050C9C] focus:ring-2 focus:ring-[#050C9C]/20 outline-none transition" placeholder="Masukkan judul dokumen" required>
                        </div>

                        <div>
                            <label class="block text-sm font-semibold mb-2 text-gray-800">Nomor Dokumen</label>
                            <input type="text" name="nomor_dokumen" value="<?php echo e(old('nomor_dokumen')); ?>" class="input-field w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#050C9C] focus:ring-2 focus:ring-[#050C9C]/20 outline-none transition" placeholder="Contoh: 001/SK/2025">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold mb-2 text-gray-800">Tanggal Terbit <span class="text-red-500">*</span></label>
                            <input type="text" name="tanggal_terbit" id="tanggalTerbit" value="<?php echo e(old('tanggal_terbit')); ?>" placeholder="Pilih atau ketik tanggal (dd/mm/yyyy)" class="input-field w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#050C9C] focus:ring-2 focus:ring-[#050C9C]/20 outline-none transition" required>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="kategori_id" class="custom-select input-field w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#050C9C] focus:ring-2 focus:ring-[#050C9C]/20 outline-none transition appearance-none bg-white" required>
                                ...
                                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(in_array($kategori->kategori_id, [1, 2])): ?>
                                        <option value="<?php echo e($kategori->kategori_id); ?>" <?php echo e(old('kategori_id') == $kategori->kategori_id ? 'selected' : ''); ?>><?php echo e($kategori->nama_kategori); ?></option>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="5" class="input-field w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#050C9C] focus:ring-2 focus:ring-[#050C9C]/20 outline-none transition resize-none" placeholder="Tulis deskripsi singkat dokumen..." required><?php echo e(old('deskripsi')); ?></textarea>
                        </div>
                                ...
                                <div id="hakAksesMenu" class="hidden absolute z-50 w-full mt-2 bg-white border border-gray-200 rounded-xl shadow-xl max-h-64 overflow-y-auto">
                                    <div class="p-3">
                                        ...
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="user-checkbox flex items-center px-3 py-2.5 hover:bg-gray-50 rounded-lg cursor-pointer transition" data-username="<?php echo e(strtolower($user->name)); ?>" data-useremail="<?php echo e(strtolower($user->email)); ?>">
                                                <input type="checkbox" name="owner_user_id[]" value="<?php echo e($user->id); ?>" class="hak-akses-checkbox w-4 h-4 text-[#050C9C] border-gray-300 rounded focus:ring-[#050C9C] focus:ring-2">
    ...
    <?php echo $__env->make('components.tu.upload-notification-success-tu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startPush('styles'); ?>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
<link rel="stylesheet" href="<?php echo e(asset('css/tu/upload-dokumen-tu.css')); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
<script src="<?php echo e(asset('js/tu/upload-dokumen.js')); ?>"></script>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMESTER 3 TEKNIK INFORMATIKA\PROYEK-3-PBO\APK-MANAJEMEN-DOSEN\devOps\devOps\resources\views/tu/upload-dokumen.blade.php ENDPATH**/ ?>