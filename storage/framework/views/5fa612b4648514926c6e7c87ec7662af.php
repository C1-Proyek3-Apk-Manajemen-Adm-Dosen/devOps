...
<div id="modalUpload" class="hidden fixed inset-0 bg-gray-900/30 backdrop-blur-sm flex items-center justify-center z-50">
    ...
    <div class="bg-white rounded-2xl w-full max-w-lg p-6 relative shadow-xl">
        ...
        <!-- Form Upload -->
        <form action="<?php echo e(route('dosen.upload')); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\SEMESTER 3 TEKNIK INFORMATIKA\PROYEK-3-PBO\APK-MANAJEMEN-DOSEN\devOps\devOps\resources\views/components/modals/upload-modals-dosen.blade.php ENDPATH**/ ?>