@extends('layouts.app')
@section('title', 'Dokumen Saya - SiDoRa')
                        ...
                        <tr class="hover:bg-blue-50/30 transition-all duration-200 group">
                            ...
                            <td class="py-3 px-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="{{ route('dosen.detail-dokumen', $d->dokumen_id) }}" 
...
@include('dosen.modal-edit-hak-akses')

@endsection

@push('styles')
<link rel="stylesheet" href="{{ asset('css/dosen/dokumen-saya.css') }}">
@endpush

@push('scripts')
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
@vite(['resources/js/dosen/dokumen-saya.js', 'resources/js/dosen/edit-hak-akses-modal.js'])
@endpush