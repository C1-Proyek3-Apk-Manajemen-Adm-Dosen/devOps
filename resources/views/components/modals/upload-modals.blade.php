        ...
        <form action="{{ route('dosen.upload') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <div class="flex items-center gap-3 border border-gray-300 rounded-lg px-4 py-2 bg-gray-50">
                    <button type="button" id="customFileBtnUpload"
                        class="bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition">Choose
                        File</button>
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="3" placeholder="Masukkan deskripsi singkat dokumen..."
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-purple-500 focus:outline-none"></textarea>
            </div>

            <!-- Tombol Submit -->
            <div class="text-center pt-2">
                <button type="submit"
                    class="bg-purple-600 text-white font-semibold px-6 py-2 rounded-full hover:bg-purple-700 transition">
                    Submit
                </button>
            </div>
        </form>
